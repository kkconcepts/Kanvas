<template>
    <section class="text-white copy-container grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 h-100vh w-full">
        ...
        <div class="col-span-1 flex flex-col w-full items-center justify-center f-gap-8-12">
            ...
            <div class="block-content-container f-text-13-15 f-max-w-280-490 leading-tight text-center">
